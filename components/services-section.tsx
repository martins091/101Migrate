...
const services = [
    ...
    },
    {
        ...
        image: "/immigration/professional-consultant-reviewing-documents-with-m.jpg",
        price: "From $500",
    },
    {
        id: "consultation",
    ...
    },
    {
        ...
        shortDesc: "Extraordinary Ability Reference",
        description:
            "Access a professionally structured sample EB-1A petition to understand how extraordinary ability cases are framed, documented, and presented to meet USCIS standards.",
        features: [
            "Real-world petition structure",
            "USCIS-aligned formatting",
    ...
    },
    {
        ...
        shortDesc: "National Interest Waiver Guide",
        description:
            "Review a complete sample EB-2 NIW petition demonstrating how proposed endeavors, national importance, and applicant positioning are clearly articulated for USCIS approval.",
        features: [
            "Proposed endeavor examples",
            "National importance framing",
            "Well-positioned argument samples",
            "Evidence organization layout",
            "Professional petition structure",
        ],
        image: "/professional-reviewing-immigration-documents-in-mo.jpg",
        price: "$199",
    },
...
export function ServicesSection() {
    ...
    // Scroll to service if URL has hash on initial load
    useEffect(() => {
    ...
    return (
        <section id="services" className="py-24 md:py-32 bg-muted/30 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 lg:px-12 relative z-10">
                ...
                {/* All Service Sections - Rendering all 6 services */}
                <div className="space-y-24">
                    {services.map((service, index) => (
                        <div key={service.id} id={service.id} className="scroll-mt-32">
                            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                                {/* Image */}
                                <div className={cn("relative", index % 2 === 0 ? "order-2 lg:order-1" : "order-2 lg:order-2")}>
                                ...
                                {/* Content */}
                                <div className={cn("", index % 2 === 0 ? "order-1 lg:order-2" : "order-1 lg:order-1")}>
                                    <div className="flex items-center gap-4 mb-6">
                                        <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center">
                                            <service.icon className="w-8 h-8 text-primary" />
                                        </div>
                                        <div>
                                            <span className="text-secondary font-medium text-sm">{service.shortDesc}</span>
                                            <h3 className="text-2xl md:text-3xl font-serif font-bold">{service.title}</h3>
                                        </div>
                                    </div>
...
//             "Reference letter samples",
//         ],
//         image: "/award-winning-professional-with-achievements-and-t.jpg", // same as EB-1A
//         price: "From $3,000", // same as EB-1A
//     },
//
//     {
//         id: "sample-eb2-niw",
...
//             "Professional petition structure",
//         ],
//         image: "/professional-reviewing-immigration-documents-in-mo.jpg", // same as EB-2 NIW
//         price: "From $2,500", // same as EB-2 NIW
//     },
//
//
// ]
