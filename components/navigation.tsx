    ...
    <>
      ...
      <header
        className={cn(
          ...
          isScrolled ? "bg-background/98 backdrop-blur-xl shadow-lg shadow-foreground/5 lg:top-0" : "bg-transparent",
        )}
      >
          ...
          <div className="flex items-center justify-between h-20 lg:h-24">
              ...
              {navLinks.map((link) => (
                ...
                >
                  ...
                  >
                    ...
                    {link.children && (
                      <ChevronDown
                        className={cn("w-4 h-4 transition-transform", activeDropdown === link.label && "rotate-180")}
                      />
                    )}
                  </Link>
            ...
            <button
              ...
              className={cn(
                ...
                isScrolled ? "hover:bg-muted text-foreground" : "hover:bg-background/10 text-background",
              )}
